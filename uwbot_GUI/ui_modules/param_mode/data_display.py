...
class StateDataDisplayWidget(QWidget):
    ...
    def setup_parameters(self):
        ...
        system_group.add_parameter("sta_comm_latency", "Communication Latency", 0, "ms", "int")
    ...
    def update_display(self):
        ...
        try:
            ...
            system_group.update_parameter("sta_comm_latency", system_state.sta_comm_latency)
